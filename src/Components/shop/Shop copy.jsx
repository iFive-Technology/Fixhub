...
const Shop = () => {
  return (
    <>
<div className=''>
    <div className='Shop mt-32  md:mt-52 text-white md:flex  '  style={{ 
    ...
    boxShadow: "inset 0 0 0 2000px rgba(0, 0, 0, 0.434)",
        ...
        <div className='pb-10  flex flex-col items-center justify-center md:basis-1/2'>
            ...
            <p className='text-start text-white'>We do fast phone repair. In most cases, technicians will be able to repair your device in just minutes, we’ll normally get your phone in and out in 45 minutes or less.</p>
